...
public class SellerListController implements Initializable, DataChangeListener {
	...
	public void setSellerService(SellerService service) { // evita o acoplamento forte na hora de instanciar um
																	// SellerService
	...
	public void updateTableView() {
		if (service == null) { // confere se o programador esqueceu de injetar o serviço
...
//			diologStage.setTitle("Enter Seller data");
